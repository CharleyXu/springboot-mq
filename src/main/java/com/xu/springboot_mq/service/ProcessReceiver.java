...
import com.xu.springboot_mq.config.RabbitConfig;
...
public class ProcessReceiver implements ChannelAwareMessageListener {
  ...
  public void onMessage(Message message, Channel channel) throws Exception {
    try {
      ...
      channel.basicPublish(RabbitConfig.PER_QUEUE_TTL_EXCHANGE_NAME, RabbitConfig.DELAY_QUEUE_PER_QUEUE_TTL_NAME, null,
